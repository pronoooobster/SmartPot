 ...
 * Version: V1.27
 * Note(s): Modifed By Rob F. / Entire Group ...
 *----------------------------------------------------------------------------
...
//                     < 0=> HCLK = [0xxx] SYSCLK
//                     < 8=> HCLK = [1000] SYSCLK / 2
//                     < 9=> HCLK = [1001] SYSCLK / 4
//                     <10=> HCLK = [1010] SYSCLK / 8
//                     <11=> HCLK = [1011] SYSCLK / 16
//                     <12=> HCLK = [1100] SYSCLK / 64
//                     <13=> HCLK = [1101] SYSCLK / 128
//                     <14=> HCLK = [1110] SYSCLK / 256
//                     <15=> HCLK = [1111] SYSCLK / 512
//     <o2.0..1> SW: System Clock Switch
//       <i> Default: SYSCLK = HSE
//                     <0=> SYSCLK = [00] HSI
//                     <1=> SYSCLK = [01] HSE
//                     <2=> SYSCLK = [10] PLLCLK
//                     <3=> SYSCLK = [11] notApplicable (ERROR)
//   </h>
//   <o3>HSE: External High Speed Clock [Hz] <4000000-32000000>
//   <i> clock value for the used External High Speed Clock (4MHz <= HSE <= 32Hz).
//   <i> Default: 8000000  (8MHz)
// </e> End of Clock Configuration
#define __CLOCK_SETUP              1
#define __RCC_CR_VAL               0x0101007B
#define __RCC_CFGR_VAL             0x00110082
...
#define __TIMER_INTERRUPTS        0x0006                  //  3
#define __TIM1_PERIOD             1000//0x003E8                 //  4
#define __TIM1_PSC                0x0000                  //  5
#define __TIM1_ARR                0x0FFF                  //  6
#define __TIM1_RCR                0x0070                  //  7
#define __TIM1_CR1                0x0084                  //  8
#define __TIM1_CR2                0x0080                  //  9
#define __TIM1_SMCR               0x0000                  // 10
#define __TIM1_CCMR1              0x00E1                  // 11
#define __TIM1_CCMR2              0x6031                  // 12
#define __TIM1_CCER               0x0200                  // 13
#define __TIM1_CCR1               0x0000                  // 14
#define __TIM1_CCR2               0x0000                  // 15
#define __TIM1_CCR3               0x0000                  // 16
#define __TIM1_CCR4               0x0100                  // 17
#define __TIM1_BDTR               0x0000                  // 18
#define __TIM1_DIER               0x0001                  // 19
#define __TIM2_PERIOD             991//0xB71B0                 // 20
...
#define __TIM3_PERIOD             1000//0x7A120                 // 34
...
#define __TIM4_PERIOD             500//0x3D090                 // 48
...
#define __EXTI_INTERRUPTS         0x00000BE9              //  2
#define __EXTI_IMR                0x00000BE9              //  3
#define __EXTI_EMR                0x00000000              //  4
#define __EXTI_RTSR               0x000008E8              //  5
#define __EXTI_FTSR               0x00000BE9              //  6
#define __AFIO_EXTICR1            0x00000000              //  7
#define __AFIO_EXTICR2            0x00001100              //  8
#define __AFIO_EXTICR3            0x00001011              //  9
...
//--------------------------------------------------------------------------- CAN remapping
//   <o1.24..26> JTAG remapping
//      <i> Default: No Remap FULL SWJ (JTMS/PA13, JTCK/PA14, JTDI/PA15, JTDO/PB3, NJTRST/PB4)
//        <0=>         No Remap FULL SWJ (JTMS/PA13, JTCK/PA14, JTDI/PA15, JTDO/PB3, NJTRST/PB4)
//        <1=>         Remap FULL SWJ WithOut NJTRST (JTMS/PA13, JTCK/PA14, JTDI/PA15, JTDO/PB3) 
//        <2=>         Remap SW-DP (SWDIO/PA13, SWCLK/PA14)
//        <4=>         Remap JTAG-DP Disabled and SW-DP Disabled

// </e> End of Alternate Function remap Configuration
#define __AFREMAP_SETUP           1                       //  0
#define __AFIO_MAPR               0x02000000              //  1

//=========================================================================== General purpose I/O StartUp
// <e0> GPIOA StartUp Value
//  <o1.00>PBA0  <o1.01>PBA1  <o1.02>PBA2  <o1.03>PBA3  <o1.04>PBA4  <o1.05>PBA5  <o1.06>PBA6  <o1.07>PBA7
//  <o1.08>PBA8  <o1.09>PBA9  <o1.10>PBA10 <o1.11>PBA11 <o1.12>PBA12 <o1.13>PBA13 <o1.14>PBA14 <o1.15>PBA15
// </e> End of GPIO StartUp
#define __GPIOAS_E                1                                 //  1
#define __GPIOAS_V                0xFFFFFFFF                        //  0xFFFFFFFF
// <e0> GPIOB StartUp Value
//  <o1.00>PBB0  <o1.01>PBB1  <o1.02>PBB2  <o1.03>PBB3  <o1.04>PBB4  <o1.05>PBA5  <o1.06>PBB6  <o1.07>PBB7
//  <o1.08>PBB8  <o1.09>PBB9  <o1.10>PBB10 <o1.11>PBB11 <o1.12>PBB12 <o1.13>PBA13 <o1.14>PBB14 <o1.15>PBB15
// </e> End of GPIO StartUp
#define __GPIOBS_E                1                                 //  1
#define __GPIOBS_V                0xFFFFFFFF                        //  0xFFFFFFFF
// <e0> GPIOC StartUp Value
//  <o1.00>PBC0  <o1.01>PBC1  <o1.02>PBC2  <o1.03>PBC3  <o1.04>PBC4  <o1.05>PBC5  <o1.06>PBC6  <o1.07>PBC7
//  <o1.08>PBC8  <o1.09>PBC9  <o1.10>PBC10 <o1.11>PBC11 <o1.12>PBC12 <o1.13>PBC13 <o1.14>PBC14 <o1.15>PBC15
// </e> End of GPIO StartUp
#define __GPIOCS_E                1                                 //  1
#define __GPIOCS_V                0xFFFFFFFF                        //  0xFFFFFFFF

// <e0> GPIOD StartUp Value
//  <o1.00>PBD0  <o1.01>PBD1  <o1.02>PBD2  <o1.03>PBD3  <o1.04>PBD4  <o1.05>PBD5  <o1.06>PBD6  <o1.07>PBD7
//  <o1.08>PBD8  <o1.09>PBD9  <o1.10>PBD10 <o1.11>PBD11 <o1.12>PBD12 <o1.13>PBD13 <o1.14>PBD14 <o1.15>PBD15
// </e> End of GPIO StartUp
#define __GPIODS_E                1                                 //  1
#define __GPIODS_V                0xFFFFFFFF                        //  0xFFFFFFFF
// <e0> GPIOE StartUp Value
//  <o1.00>PBE0  <o1.01>PBE1  <o1.02>PBE2  <o1.03>PBE3  <o1.04>PBE4  <o1.05>PBE5  <o1.06>PBE6  <o1.07>PBE7
//  <o1.08>PBE8  <o1.09>PBE9  <o1.10>PBE10 <o1.11>PBE11 <o1.12>PBE12 <o1.13>PBE13 <o1.14>PBE14 <o1.15>PBE15
// </e> End of GPIO StartUp
#define __GPIOES_E                0                                 //  1
#define __GPIOES_V                0xFFFFFFFF                        //  0xFFFFFFFF
// <e0> GPIOF StartUp Value
//  <o1.00>PBF0  <o1.01>PBF1  <o1.02>PBF2  <o1.03>PBF3  <o1.04>PBF4  <o1.05>PBF5  <o1.06>PBF6  <o1.07>PBF7
//  <o1.08>PBF8  <o1.09>PBF9  <o1.10>PBF10 <o1.11>PBF11 <o1.12>PBF12 <o1.13>PBF13 <o1.14>PBF14 <o1.15>PBF15
// </e> End of GPIO StartUp
#define __GPIOFS_E                0                                 //  1
#define __GPIOFS_V                0xFFFFFFFF                        //  0xFFFFFFFF
// <e0> GPIOG StartUp Value
//  <o1.00>PBG0  <o1.01>PBG1  <o1.02>PBG2  <o1.03>PBG3  <o1.04>PBG4  <o1.05>PBG5  <o1.06>PBG6  <o1.07>PBG7
//  <o1.08>PBG8  <o1.09>PBG9  <o1.10>PBG10 <o1.11>PBG11 <o1.12>PBG12 <o1.13>PBG13 <o1.14>PBG14 <o1.15>PBG15
// </e> End of GPIO StartUp
#define __GPIOGS_E                0                                 //  1
#define __GPIOGS_V                0xFFFFFFFF                        //  0xFFFFFFFF
...
#define __EFI_ACR_Val             0x00000031
 ...
 *----------------------------------------------------------------------------*/
#define __SYSTICK_LOAD (((__SYSTICKCLK/1000)*__SYSTICK_PERIOD)/1000)
__inline static void stm32_SysTickSetup (void) {

#if ((__SYSTICK_LOAD-1) > 0xFFFFFFFF)       // reload value to large
...
//  SysTick->LOAD  = __SYSTICK_PERIOD*(__SYSTICKCLK/*/1000*/)-1;      // set reload register
  SysTick->LOAD  = __SYSTICK_LOAD-1; // __SYSTICK_PERIOD*(__SYSTICKCLK/*/1000*/)-1;      // set reload register
...
unsigned int stm32_TimerGetReload (char tnum)
{
        switch (tnum)
        {
#if __SYSTICK_SETUP
          case 0:
            return(__SYSTICK_PERIOD);
#endif
#if __TIMER_SETUP
          case 1:
            return(__TIM1_PERIOD);
          case 2:
            return(__TIM2_PERIOD);
          case 3:
            return(__TIM3_PERIOD);
          case 4:
            return(__TIM4_PERIOD);
        }
#endif
        return(0);
}
...
__inline static void stm32_GpioSetup (void) {
  ...
  if (__GPIOAS_E) GPIOA->BSRR = __GPIOAS_V;
  ...
  if (__GPIOBS_E) GPIOB->BSRR = __GPIOBS_V;
  ...
  if (__GPIOCS_E) GPIOC->BSRR = __GPIOCS_V;
  ...
  if (__GPIODS_E) GPIOD->BSRR = __GPIODS_V;
  ...
  if (__GPIOES_E) GPIOE->BSRR = __GPIOES_V;
  ...
  if (__GPIOFS_E) GPIOF->BSRR = __GPIOFS_V;
  ...
  if (__GPIOGS_E) GPIOG->BSRR = __GPIOGS_V;
...
__inline static void stm32_AfRemapSetup (void) {
  ...
  if (__AFIO_MAPR & (7 << 24)) {                            // JTAG remap used 

    RCC->APB2ENR |= RCC_APB2ENR_AFIOEN;                     // enable clock for Alternate Function
    AFIO->MAPR &= ~(7 << 24);                               // clear used bit
    AFIO->MAPR |= ((7 << 24) & __AFIO_MAPR);                // set used bits
  } // end JTAG remap used
